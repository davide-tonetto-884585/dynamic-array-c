...
bool_t _dyn_arr_contains_elem(void *data, size_t dataSize, dyn_arr_info_t *info, void *element, bool_t (*equals)(const void *, const void *)){
    if(dataSize == 0)
        return FALSE;
...
int _dyn_arr_index_of_elem(void *data, size_t dataSize, int cont, dyn_arr_info_t *info, void *element, bool_t (*equals)(const void *, const void *)){
    if(dataSize == 0)
        return -1;
    else if (equals(data, element))
        return cont;
